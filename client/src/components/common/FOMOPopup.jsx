    ...
    <>
      ...
      <div className={`fomo-popup ${closing ? 'fomo-out' : ''}`}>
        ...
        <div className="fomo-live-badge">
          ...
          200,000+ users active right now
        </div>
        ...
        <p className="fomo-sub">Join <strong>200K+ smart investors</strong> who let veteran traders do the heavy lifting.</p>
        <div className="fomo-social-proof">
          ...
          <span className="fomo-joined-text"><strong>67 people</strong> joined in the last hour</span>
        </div>
        <div className="fomo-stats">
          <div className="fomo-stat"><span className="fomo-stat-val">$142K+</span><span className="fomo-stat-label">Paid out this week</span></div>
